      ...
      <div className="contact-container">
        ...
        <div className="top">
          ...
          <div className="contact-info">
            <p><strong>Our Instagram handle:</strong> <a href="">@bloom.branding_</a></p>
            <p><strong>Visit us:</strong> 📍 Location</p>
            <p><strong>Drop us a Mail:</strong> hello.bloombranding@gmail.com</p>
          </div>
        </div>
